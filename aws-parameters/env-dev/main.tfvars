parameters = [
  ...
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devopsjob.online:8080/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devopsjob.online:8080/", type = "String" },
  ...
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devopsjob.online:8080", type = "String" },
