parameters = [
  ...
  { name = "dev.frontend.user_url", value = "http://user-dev.devopsjob.online:8080/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devopsjob.online:8080/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "shipping-dev.devopsjob.online:8080/", type = "String" },
  { name = "dev.frontend.payment_url", value = "payment-dev.devopsjob.online:8080/", type = "String" },
  { name = "dev.user.mongo", value = "true", type = "String" },
  { name = "dev.user.redis_host", value = "redis_dev.devopsjob.online", type = "String" },
  { name = "dev.user.mongo_url", value = "mongodb-dev://mongodb-dev.devopsjob.online:27017/catalogue", type = "String" },
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devopsjob.online", type = "String" },
  { name = "dev.shipping.db_host", value = "mysql-dev.devopsjob.online", type = "String" },
  { name = "dev.payment.cart_host", value = "payment-dev.devopsjob.online", type = "String" },
